      ...
      >
        <div className="p-8 pb-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <Link href="https://discord.com/oauth2/authorize?client_id=1350933866076049428&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fapi%2Fauth%2Fcallback%2Fdiscord&scope=identify+email+connections">
              <svg
